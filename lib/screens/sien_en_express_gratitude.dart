...
class SienEnExpressGratitude extends StatelessWidget {
  const SienEnExpressGratitude({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppbarWidget(title: "Sien En - Gratitude Express"),
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                "This prayer is done after Dharma Meeting or any Activity",
              ...
              RowItemWidget(
                ...
                col3: "Yi, Erl..Ciu,Yi, Er..chui,Yi Chien Khou Shou",
              ),
              RowItemWidget(
              ...
              RowItemWidget(
                col1: "Ciau Hua Phu Sa,Yi Khou Sou",
                col2: "Yi Khou Sou",
                col3: "Yi Khou Shou",
              ),
              RowItemWidget(
