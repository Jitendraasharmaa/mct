...
import '../wigets/row_items_widget.dart';

class NewYearCeremony extends StatelessWidget {
  const NewYearCeremony({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppbarWidget(title: "New Year Ceremony"),
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                "Usually will be Performed 1 day before Chinese New Year at 11.30 pm",
              ...
              SizedBox(height: 5.0),
              Text("Tao Temple : 25 Plate"),
              Text("Family Temple	: 15 Plate"),
              SizedBox(height: 10.0),
              Text(
                "II.Offering Prasada Ceremony",
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontStyle: FontStyle.italic,
                ),
              ...
              RowItemWidget(
                ...
                col2: "Wu Pai Khou Sou",
                col3: "Yi, Erl, San, …, Ciu, Yi Pai Khou Shou",
              ),
              SizedBox(height: 15.0),
              Text(
                "III.Maitreya Jayanti Ceremony",
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontStyle: FontStyle.italic,
                ),
              ...
              RowItemWidget(
                col1: "Chi,Cuo Yi,Kuei",
                col2: "Cu Sien Siang San Cu",
                col3: "Yi Sien,Cai Sien,San Sien",
              ),
              RowItemWidget(
                col1: "Siang Mi Le Cu Se, Pai Shou",
                col2: "San Khou Shou",
              ...
              SizedBox(height: 10.0),
              Text(
                "IV.	Festival Ceremony (Pai Nian Li Cie)",
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontStyle: FontStyle.italic,
                ),
              ...
              RowItemWidget(
                col1: "Siang Ming Ming Shang Ti Pai Nien",
                col2: "Se Khou Shou",
                col3: "Yi Khou...Se Khou Shou",
              ),
              RowItemWidget(
                col1: "Siang Cu Thien Shen Shen Pai Nien",
                col2: "Wu Khou Shou",
                col3: "Yi Khou...Wu Khou Shou",
              ),
              RowItemWidget(
                col1: "Siang Mi Le Cu Se Pai Nien ",
                col2: "Wu Khou Shou",
                col3: "Yi Khou...Wu Khou Shou",
              ),
              RowItemWidget(
                col1: "Siang Nan Hao Ku Fo Pai Nien",
                col2: "San Khou Shou",
                col3: "Yi Khou,Cai Khou,San Khou Shou",
              ),
              RowItemWidget(
              ...
              RowItemWidget(
                col1: "Siang Cin Kong Cu Se Pai Nien",
                col2: "Wu Khou Shou",
                col3: "Yi Khou,Cai Khou..Wo Khou Shou..",
              ),
              RowItemWidget(
                col1: "Siang Thien Ran Ku Fo  Pai Nien",
                col2: "Wu Khou Shou",
                col3: "Yi Khou,Cai Khou..Wo Khou Shou..",
              ),
              RowItemWidget(
                col1: "Siang Cong Hua Shen Mu Pai Nien",
                col2: "Wu Khou Shou",
                col3: "Yi Khou,Cai Khou..Wo Khou Shou..",
              ),
              RowItemWidget(
              ...
              SingleParaTextWidget(text: "Chi, Cuo Yi Kuei"),
              RowItemWidget(
                col1: "Kei Ke Wei Tien Chuan Se Pai Nien",
                col2: "Yi Khou Shou",
                col3: "Yi Khou Shou",
              ),
              SizedBox(height: 10.0),
              SingleParaTextWidget(
                text: "Chi, Cuo Yi, Pai Nien Li Pi Chuei Shou Ci Kong Thuei",
              ),
